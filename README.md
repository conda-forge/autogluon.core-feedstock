...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/autogluon.core-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/autogluon.core-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add autogluon.core
# for installing globally
pixi global install autogluon.core
```
...
It is possible to list all of the versions of `autogluon.core` available on your platform:
...
```
pixi search autogluon.core --channel conda-forge
```
